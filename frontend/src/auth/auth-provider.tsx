...
const USER_KEY = 'forage_user';
const TOKEN_EXPIRY_KEY = 'forage_token_expiry';
...
const DEMO_USER: UserInfo = { email: 'demo@forage.app', name: 'Demo User', picture: '' };
      ...
      tokenClientRef.current = google.accounts.oauth2.initTokenClient({
        ...
        callback: async (response: any) => {
          ...
          if (reauthResolveRef.current) {
            // Silent reauth: re-use cached user
