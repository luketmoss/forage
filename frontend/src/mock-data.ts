...
// ===== Label Colors (matches Thrive pattern) =====
...
export const mockLabels: Label[] = [
  { id: 'lbl-1', name: 'Quick', colorKey: 'green' },
  { id: 'lbl-2', name: 'Dinner', colorKey: 'blue' },
  { id: 'lbl-3', name: 'Baking', colorKey: 'amber' },
  { id: 'lbl-4', name: 'Healthy', colorKey: 'teal' },
  { id: 'lbl-5', name: 'Comfort', colorKey: 'orange' },
  { id: 'lbl-6', name: 'Weeknight', colorKey: 'purple' },
];
